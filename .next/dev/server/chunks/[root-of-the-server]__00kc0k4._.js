...
"[project]/src/app/api/contentstack/test/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    ...
    try {
        const cts = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$contentstack$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["listContentTypes"])(body.config);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ok: true,
            contentTypeCount: cts.length
        });
    } catch (err) {
        const message = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].isAxiosError(err) ? err.response?.data?.error_message || err.message : err instanceof Error ? err.message : "test_failed";
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ok: false,
            error: message
        }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__00kc0k4._.js.map