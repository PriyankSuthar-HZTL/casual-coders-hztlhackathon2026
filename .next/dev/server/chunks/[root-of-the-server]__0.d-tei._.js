...
"[project]/src/app/api/contentstack/login/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    const { email, password, tfa_token, region } = await request.json();
    if (!email || !password) {
    ...
    const baseURL = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$contentstack$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["REGION_HOSTS"][region] ?? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$contentstack$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["REGION_HOSTS"].na;
    const body = {
        user: {
            email,
            password,
    ...
    try {
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].post(`${baseURL}/v3/user-session`, body, {
            headers: {
                "Content-Type": "application/json"
            },
            validateStatus: ()=>true,
        ...
        if (data.error_code === 294) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                ok: false,
                needsTfa: true,
                tfaType: data.tfa_type,
                error: data.error_message ?? "Two-factor authentication required."
            });
        }
        ...
        if (!user?.authtoken) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                ok: false,
                error: data.error_message ?? data.error ?? "Login failed."
            });
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ok: true,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0.d-tei._.js.map