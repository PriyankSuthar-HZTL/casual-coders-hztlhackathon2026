...
"[project]/src/app/api/contentstack/fetch-page-types/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function extractBlockUids(schema) {
    const uids = [];
...
function hasModularBlocksField(schema) {
...
async function POST(request) {
    ...
    try {
        const all = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$contentstack$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["listContentTypes"])(body.config);
        const pageTypes = all.filter((ct)=>{
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ok: false,
            pageTypes: [],
            error: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$contentstack$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["describeCsError"])(err)
        }, {
            status: 502
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0wnaxfr._.js.map